...
export class FeiDao__getActionsResult {
...
export class FeiDao__getReceiptResultValue0Struct extends ethereum.Tuple {
...
export class FeiDao__proposalsResult {
  value0: BigInt;
  value1: Address;
  value2: BigInt;
  value3: BigInt;
...
export class FeiDao extends ethereum.SmartContract {
  static bind(address: Address): FeiDao {
    return new FeiDao("FeiDao", address);
  }
  ...
  getActions(proposalId: BigInt): FeiDao__getActionsResult {
    let result = super.call(
      "getActions",
    ...
    return new FeiDao__getActionsResult(
  ...
  try_getActions(
    proposalId: BigInt
  ): ethereum.CallResult<FeiDao__getActionsResult> {
    let result = super.tryCall(
      "getActions",
      "getActions(uint256):(address[],uint256[],string[],bytes[])",
      [ethereum.Value.fromUnsignedBigInt(proposalId)]
  ...
  getReceipt(
    proposalId: BigInt,
    voter: Address
  ): FeiDao__getReceiptResultValue0Struct {
    let result = super.call(
      "getReceipt",
    ...
    return result[0].toTuple() as FeiDao__getReceiptResultValue0Struct;
  }

  try_getReceipt(
    proposalId: BigInt,
    voter: Address
  ): ethereum.CallResult<FeiDao__getReceiptResultValue0Struct> {
    let result = super.tryCall(
      "getReceipt",
      "getReceipt(uint256,address):((bool,bool,uint96))",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      value[0].toTuple() as FeiDao__getReceiptResultValue0Struct
    );
  }
  ...
  proposals(param0: BigInt): FeiDao__proposalsResult {
    let result = super.call(
      "proposals",
    ...
    return new FeiDao__proposalsResult(
      result[0].toBigInt(),
      result[1].toAddress(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_proposals(param0: BigInt): ethereum.CallResult<FeiDao__proposalsResult> {
    let result = super.tryCall(
      "proposals",
      "proposals(uint256):(uint256,address,uint256,uint256,uint256,uint256,uint256,bool,bool)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
